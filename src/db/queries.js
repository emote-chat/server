...
module.exports = {
    ...
    findChatsByUserId: new PS('find-chats-by-user-id', 'SELECT chats_id FROM users_chats WHERE users_id = $1'),
    // messages
    createMessage: new PS('create-message', 'INSERT INTO messages(chats_id, users_id, text) VALUES($1, $2, $3)'),
    findMessagesByChatId: new PS('find-messages-by-chat-id', 'SELECT * FROM messages WHERE chats_id = $1'),
}